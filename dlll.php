...
<body class="login">
 ...
 <div >文章管理系统</div>
       ...
       <form method="post" action="login1.php">
        ...
        <p><input type="text" placeholder="请输入用户名" 
		    id="username"  name="username" class="text_box"/></p>
        <p><input type="text"  placeholder="请输入密码" id="password"  name="password"             class="text_box"/></p>
